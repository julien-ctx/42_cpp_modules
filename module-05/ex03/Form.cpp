...
/*   Updated: 2022/10/14 19:14:15 by jcauchet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Form.hpp"

Form::Form() : _target("default target"), _name("Unknown"), _sign(false), _signGrade(150), _execGrade(150)
{
	std::cout << "Form: Default constructor has been called and grades have been set to 150\n";
}
Form::Form(std::string name, int signGrade, int execGrade) : _target("default target"), _name(name), _sign(false), _signGrade(checkValue(signGrade)) , _execGrade(checkValue(execGrade)) {}
